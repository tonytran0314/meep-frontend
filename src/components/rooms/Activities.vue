...
<template>
    <div class="flex justify-around">
        ...
        <div class="relative">
            ...
            <span v-show="notification.newNotifcationIndicator" class="bg-red-400 rounded-full text-xs absolute top-1 right-1 size-2 flex items-center justify-center"></span>
        </div>
