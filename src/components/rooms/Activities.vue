<script setup>
    ...
    const openNewGroupModal = () => {
        modal.open(NewGroupModal, { title: 'New Group Chat' })
    }
...
<template>
    <div class="flex justify-around">
        ...
        <font-awesome-icon @click="openNewGroupModal" :icon="['fas', 'comment-medical']" class="size-6 text-gray-700 dark:text-blue-50 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer p-3 rounded-full" />
    </div>
</template>
